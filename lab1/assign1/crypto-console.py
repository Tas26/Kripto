...
def run_railfence():
    ...
    print("{}crypting {} using Railfence cipher and circumference {}...".format('En' if encrypting else 'De', data, num_rails))

    output = (encrypt_railfence if encrypting else decrypt_railfence)(data, int(num_rails))
